package org.drools.demo.demo20230606_kjar_no_execmodel;
...
public class AppNoExecmodel {
    public static Logger LOG = LoggerFactory.getLogger(AppNoExecmodel.class);
    static Scanner s = new Scanner(System.in);
    static String JSON;

    public static void main(String[] args) throws Exception {
        LOG.info("App starting.");
        JSON = Files.readString(Paths.get(AppNoExecmodel.class.getResource("/test1.json").toURI()));
    ...
    private static void doOnce(KieServices ks) throws Exception {
        KieContainer kieContainer = ks.newKieContainer(ks.newReleaseId("org.drools.demo", "demo20230606-kjar-no-execmodel", "1.0-SNAPSHOT"));
